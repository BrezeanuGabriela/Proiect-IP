...
namespace ProiectIP
{
    class Produs
    {
        ...
        {
            return "Produsul " + Denumire + " costa: " + Pret.ToString() + ", si contine urmatoarele: " + AfisareIngrediente();
        }
        ...
        public void EliminareIngredient(string ingredient)
        {
            ...
            try
            {
                ...
                Console.WriteLine("Am scors ingredientul: " + ingredient + " din produsul: " + Denumire);
            }
            catch
            {
